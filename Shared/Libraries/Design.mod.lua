...
return function(wrapper)
	...
	ulist[Red] = Red[500];
	ulist[Pink] = Pink[500];
	ulist[Purple] = Purple[500];
	ulist[DeepPurple] = DeepPurple[500];
	ulist[Indigo] = Indigo[500];
	ulist[Blue] = Blue[500];
	ulist[LightBlue] = LightBlue[500];
	ulist[Cyan] = Cyan[500];
	ulist[Teal] = Teal[500];
	ulist[Green] = Green[500];
	ulist[LightGreen] = LightGreen[500];
	ulist[Lime] = Lime[500];
	ulist[Yellow] = Yellow[500];
	ulist[Amber] = Amber[500];
	ulist[Orange] = Orange[500];
	ulist[DeepOrange] = DeepOrange[500];
	ulist[Brown] = Brown[500];
	ulist[Grey] = Grey[500];
	ulist[BlueGrey] = BlueGrey[500];
	local wlist = wrapper.wlist.ref;
	wlist[Red] = Red;
	wlist[Pink] = Pink;
	wlist[Purple] = Purple;
	wlist[DeepPurple] = DeepPurple;
	wlist[Indigo] = Indigo;
	wlist[Blue] = Blue;
	wlist[LightBlue] = LightBlue;
	wlist[Cyan] = Cyan;
	wlist[Teal] = Teal;
	wlist[Green] = Green;
	wlist[LightGreen] = LightGreen;
	wlist[Lime] = Lime;
	wlist[Yellow] = Yellow;
	wlist[Amber] = Amber;
	wlist[Orange] = Orange;
	wlist[DeepOrange] = DeepOrange;
	wlist[Brown] = Brown;
	wlist[Grey] = Grey;
	wlist[BlueGrey] = BlueGrey;
